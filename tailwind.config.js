  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'hero':    ['clamp(3rem, 7vw, 7rem)',   { lineHeight: '1.02', letterSpacing: '-0.03em' }],
        'display': ['clamp(2rem, 4vw, 3.75rem)', { lineHeight: '1.08', letterSpacing: '-0.03em' }],
        'headline':['clamp(1.5rem, 2.5vw, 2.5rem)', { lineHeight: '1.15', letterSpacing: '-0.02em' }],
        'title':   ['clamp(1.25rem, 2vw, 1.75rem)', { lineHeight: '1.3', letterSpacing: '-0.01em' }],
      },
      letterSpacing: {
        display: '-0.03em',
        tight:   '-0.02em',
      ...
      backgroundImage: {
        ...
        'gradient-overlay': 'linear-gradient(to bottom, transparent 0%, rgba(10,10,10,0.75) 100%)',
        'gradient-overlay-full': 'linear-gradient(to bottom, rgba(10,10,10,0.25) 0%, rgba(10,10,10,0.45) 50%, rgba(10,10,10,0.85) 100%)',
      },
      animation: {

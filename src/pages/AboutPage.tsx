...
export default function AboutPage() {
  ...
  useEffect(() => {
    aboutService.get().then(setContent).catch(() => {/* fallback to default already set */})
  }, [])

  const {
    hero_image_url, hero_eyebrow, hero_title_line1, hero_title_line2,
    mission_quote, mission_description,
    story_eyebrow, story_title_line1, story_title_line2,
    story_paragraph_1, story_paragraph_2, story_paragraph_3,
    timeline, values_eyebrow, values_title, brand_values,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <AnimatedSection animation="slide-left">
              ...
              <h2 className="font-display text-headline font-light text-brand-black mb-6">
                {story_title_line1}<br />{story_title_line2}
              </h2>
              <p className="font-sans text-sm text-brand-muted leading-relaxed mb-4">{story_paragraph_1}</p>
              <p className="font-sans text-sm text-brand-muted leading-relaxed mb-4">{story_paragraph_2}</p>
              <p className="font-sans text-sm text-brand-muted leading-relaxed">{story_paragraph_3}</p>
            </AnimatedSection>
      ...
      <section className="section-padding bg-brand-black">
        <div className="container-wide">
          <AnimatedSection animation="fade-up" className="text-center mb-16">
            ...
            <h2 className="font-display text-display font-light text-white">{values_title}</h2>
          </AnimatedSection>

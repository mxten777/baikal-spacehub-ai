                ...
                <div>
                  ...
                  <div className="space-y-0">
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <p className="font-sans text-[9px] tracking-widest uppercase text-brand-subtle mb-0.5">
                          전화
                        </p>
              ...
              <div className="space-y-8">
                <div className="space-y-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="font-sans text-[9px] tracking-widest uppercase text-brand-subtle mb-1">
                        주소
                      </p>

...
const FALLBACK_MAP: Record<string, any> = {
  cafe: {
    ...
    size_sqm: 85,
    description:
      "커피 향과 자연광이 만나는 곳. 30m 여정의 끝, 빛이 가장 따뜻하게 머무는 공간입니다. 낭독회부터 소셜 나이트, 팝업 마켓, 브랜드 쇼룸까지 — 더릿 경험의 시작점이자 마지막 기억이 되는 카페입니다.",
    features: [
      "자연 채광",
      "커피 바",
      "빔 프로젝터",
  ...
  garden: {
    ...
    size_sqm: 200,
    description:
      "담장 너머 갑자기 열리는 하늘. 살구나무 아래, 사계절이 다른 표정을 가진 정원. 어둠의 통로를 지나 처음 빛을 만나는 순간의 공간입니다. 이 해방감이 더릿의 WOW 포인트입니다. 웨딩 리셉션, 가든 파티, 야외 공연, 브랜드 런칭에 최적입니다.",
    features: [
      "야외 테라스",
      "조명 시스템",
      "음향 시스템",
  ...
  studio: {
    ...
    size_sqm: 65,
    description:
      "낡은 창고를 해체하고 다시 세운 흰 공간. 아무것도 없는 듯 보이지만 모든 가능성이 열려 있습니다. 사이클로라마 너머 자연광이 쏟아지는 유일한 스튜디오로, 여기서 찍히는 모든 것은 더릿의 빛을 담습니다. 뮤직비디오·화보·CF·소규모 공연에 최적입니다.",
    features: [
      "사이클로라마",
      "전문 조명",
      "분장실",
  ...
  storage: {
    ...
    size_sqm: 280,
    description:
      "높이 5.5m, 완전히 열린 공간. 어떤 무대든, 어떤 전시든, 어떤 이야기든 담을 수 있습니다. 오픈 플로어와 전시 레일, 전문 조명으로 자유로운 공간 구성이 가능합니다. 대형 브랜드 이벤트·컨퍼런스·갤라 디너·아트페어에 최적입니다.",
    features: [
      "오픈 플로어",
      "5.5m 높은 천장",
      "전시 벽면",

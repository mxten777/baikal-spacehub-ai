    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50">
        ...
        <motion.div
          ...
          animate={{ backgroundColor: BG[currentPhase], boxShadow: SHADOW[currentPhase] }}
          style={{ transition: 'backdrop-filter 500ms cubic-bezier(0.25,0.1,0.25,1)' }}
          ...
          <div className="flex items-center justify-between h-16 lg:h-[72px]">
              ...
              {NAV_ITEMS.map((item) => (
                <div
                  ...
                  onMouseEnter={() => {
                    ...
                    else { if (closeTimer.current) clearTimeout(closeTimer.current); setActiveMega(null) }
                  }}
                ...
                >
                  <NavLink
                    ...
                    className={({ isActive }) => {
                      const base = 'relative block px-[13px] py-2 font-sans text-[10.5px] font-medium tracking-[0.16em] uppercase transition-colors duration-300'
                      const line = `after:absolute after:bottom-0 after:left-[13px] after:right-[13px] after:h-px after:bg-current after:transition-all after:duration-500 ${
                        isActive ? 'after:w-auto after:opacity-100' : 'after:w-0 after:opacity-0 hover:after:w-auto hover:after:opacity-100'
                      }`
                      const color = lightText
                        ? isActive ? 'text-white' : 'text-white/50 hover:text-white'
                        : isActive ? 'text-brand-black' : 'text-brand-subtle hover:text-brand-black'
            ...
            <div className="hidden lg:flex items-center gap-1">
              ...
              <motion.button
                ...
                animate={{ color: lightText ? 'rgba(255,255,255,0.55)' : '#A0A0A0' }}
              ...
              >
                ...
                />
                <motion.span
                  animate={{ color: lightText ? 'rgba(255,255,255,0.45)' : '#B0B0B0' }}

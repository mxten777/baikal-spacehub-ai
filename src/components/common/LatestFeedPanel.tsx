    ...
    <>
      <div className="flex-1 min-w-0 pr-2">
        <div className="flex items-center gap-2 mb-1">
          <span className="font-sans text-[8px] tracking-[0.18em] uppercase text-brand-subtle">
            {item.type}
          </span>
          {item.isNew && (
            <span className="font-sans text-[7.5px] tracking-[0.1em] uppercase bg-rose-500 text-white px-[5px] py-[2px] leading-none">
              NEW
            </span>
          )}
        </div>
        <p className="font-sans text-[13px] text-brand-black group-hover:text-brand-accent transition-colors duration-200 truncate leading-snug">
          {item.label}
        </p>
      ...
      <ArrowUpRight
        size={12}
        className="shrink-0 mt-1 text-brand-line group-hover:text-brand-black transition-colors duration-200"
      />
    </>
  );
        ...
        <>
          ...
          >
            ...
            <div className="flex items-start justify-between px-8 pt-8 pb-6 border-b border-brand-line">
              <div>
                <p className="font-sans text-[8px] tracking-[0.26em] uppercase text-brand-subtle mb-1.5">
                  What's New
                </p>

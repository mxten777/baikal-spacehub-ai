...
export default function UpcomingProgramsSection() {
  ...
  const displayPrograms = (programs && programs.length > 0 ? programs : FALLBACK_PROGRAMS).slice(0, 3)
      ...
      <div className="container-wide">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-16 lg:mb-20">
          <SectionHeader
            ...
            light
          />
          <Link to="/programs" className="btn-ghost-light shrink-0 self-end mb-1">
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/10">
            {displayPrograms.map((program, i) => (
              <AnimatedSection key={program.id} animation="fade-up" delay={i * 100}>
                <Link
                ...
                >
                  ...
                  <div className="flex flex-col flex-1 p-7">
                    ...
                    <div className="flex flex-col gap-2 mt-auto">
                      <div className="flex items-center gap-2.5 text-[11px] text-white/35 tracking-wide">
                        ...
                        <span>
                          ...
                          {program.start_date && program.end_date && program.start_date !== program.end_date && (
                    ...
                    <div className="flex items-center gap-2 mt-6 pt-5 border-t border-white/10">
                      ...
                      <ArrowRight size={12} className="text-white/30 group-hover:text-brand-accent group-hover:translate-x-1 transition-all duration-300" />
                    </div>
                  </div>
                </Link>
              </AnimatedSection>
